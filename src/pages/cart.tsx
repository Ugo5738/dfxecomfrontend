...
const Cart = () => {
  ...
  return (
    <Box>
      ...
      {/* <ScrollNav /> */}
      {isSuccess && (
        <Box className="mx-auto w-[98%]" backgroundColor="#ebebf5">
          <div className="order container mb-5 pt-5">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Flex display={{ base: "none", md: "flex" }} title="Quantity" minW="4rem">
                            <Select
                              size="md"
                              border="none"
                              outline="none"
                              ...
                              value={quantity}
                              onChange={(e) => {
                                void handleItemQuantityChange(product.sku, Number(e.target.value));
                              }}
                            >
